        ...
        <div class="col-md-5">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="bg-primary p-5 text-center text-white">
                    ...
                    <p class="opacity-75 small mt-2">Te enviaremos un enlace para restablecerla</p>
                </div>
                <div class="card-body p-5">
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('login') }}" class="text-muted small text-decoration-none">Volver al inicio de sesión</a>
                    </div>
                </div>
            </div>
        </div>
