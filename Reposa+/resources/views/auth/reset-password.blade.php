        ...
        <div class="col-md-5">
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                <div class="bg-primary p-5 text-center text-white">
                    <h2 class="fw-bold mb-0">{{ __('messages.auth.reset_title') }}</h2>
                    <p class="opacity-75 small mt-2">{{ __('messages.auth.reset_subtitle') }}</p>
                </div>
                <div class="card-body p-5">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label small fw-bold text-muted">{{ __('messages.auth.new_password') }}</label>
